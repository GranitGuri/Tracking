...
void VMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (VMainWindow::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VMainWindow::xChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (VMainWindow::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VMainWindow::yChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (VMainWindow::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VMainWindow::zChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (VMainWindow::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VMainWindow::tChanged)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject VMainWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_VMainWindow.data,
      qt_meta_data_VMainWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
